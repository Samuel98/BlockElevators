package uk.co.samuelzcloud.dev.plugins.BlockElevators.Utilities;
 ...
 * uk.co.samuelzcloud.dev.plugins.BlockElevators.Utilities - CustomLogger
 */
public class CustomLogger {
    ...
    public CustomLogger(BlockElevators plugin) {
        this.plugin = plugin;
